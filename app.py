...
def create_app(db_connection_string=None, testing=None, register_extensions_flag=True, start_scheduler=False, remove_sids=False):
    ...
    app.config.update({
        ...
        'SECURITY_USER_IDENTITY_ATTRIBUTES': [
            ...
            {'email': {'mapper': uia_username_mapper}},
        ],
        ...
        'SECURITY_PASSWORD_SCHEMES': [
            'pbkdf2_sha512',  # pbkdf2 is more stable in this deployment
            'bcrypt',
        ],
...
class CustomLoginForm(LoginForm):
    ...
    def validate(self):
        ...
        # Accept either username or email in the login field to align with the UI label.
